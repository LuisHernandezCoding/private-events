...
ActiveRecord::Schema[7.0].define(version: 2022_12_21_062634) do
  ...
  create_table "event_atendees", force: :cascade do |t|
    ...
    t.index ["profile_id"], name: "index_event_atendees_on_profile_id"
  end
  ...
  add_foreign_key "event_atendees", "profiles"
